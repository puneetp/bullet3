...
class KukaGymEnv(gym.Env):
  ...
  def _termination(self):
    ...
    if (len(closestPoints)):#(actualEndEffectorPos[2] <= -0.43):
      ...
      fingerAngle = 0.3
      for i in range (300): # [Modified by Emeric]
      # for i in range (100):
        graspAction = [0,0,0.00003,0,fingerAngle] # [Modified by Emeric]
        #graspAction = [0,0,0.0001,0,fingerAngle]
        self._kuka.applyAction(graspAction)
        p.stepSimulation()
        fingerAngle = fingerAngle-(0.3/300.)
        if (fingerAngle<0):
          fingerAngle=0

      for i in range (5000): # [Modified by Emeric]
      # for i in range (1000):
        graspAction = [0,0,0.0001,0,fingerAngle] # [Modified by Emeric]
